...
import Qustion2.commmission.CommissionEmployee;
import Qustion2.hourlry.HourlyEmployee;
import Qustion2.salaryemployer.SalariedEmployee;
public class Test_Employee {
   public static void main(String[] args) {
       // Creating instances of each type of Employee
       CommissionEmployee commissionEmployee = new commmission();
       ...
       CommissionEmployee basePlusCommissionEmployee = CommissionEmployee();
