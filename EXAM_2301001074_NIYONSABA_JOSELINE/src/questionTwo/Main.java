...
public class Main {
	public static  void main(String[] args) {
		...
		System.out.println("GHS has Spent for salary to  "+Alice.getName()+" and now has $"+ Alice.getSalary());
		Bob.receiveSalary(Bob.getSalary());
		System.out.println("GHS has Spent for salary to  "+Bob.getName()+" and now has $"+ Bob.getSalary());
